...
# Convertir la columna 'fecha_hora' a tipo datetime para facilitar los cálculos
df['fecha_hora'] = pd.to_datetime(df['fecha_hora'], format='%Y-%m-%d %H:%M:%S')

# Calcular la diferencia entre cada fila y la fila anterior en la columna 'fecha_hora'
